...
size_t Packet::genReadVpeGryoBasicTuning(ErrorDetectionMode errorDetectionMode, char *buffer, size_t size)
{
	#if VN_HAVE_SECURE_CRT
...
size_t Packet::genWriteVpeGryoBasicTuning(ErrorDetectionMode errorDetectionMode, char *buffer, size_t size, vec3f angularWalkVariance, vec3f baseTuning, vec3f adaptiveTuning)
{
	#if VN_HAVE_SECURE_CRT
...
void Packet::parseVpeGryoBasicTuning(vec3f* angularWalkVariance, vec3f* baseTuning, vec3f* adaptiveTuning)
{
	size_t parseIndex;
