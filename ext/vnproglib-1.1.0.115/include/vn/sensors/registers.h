...
struct FilterMeasurementsVarianceParametersRegister
{
	...
	math::vec3f angularRateVariance; ///< The angularRateVariance field.
	math::vec3f magneticVariance; ///< The magneticVariance field.
	math::vec3f accelerationVariance; ///< The accelerationVariance field.
	...
	FilterMeasurementsVarianceParametersRegister(
		...
		math::vec3f angularRateVarianceIn,
		math::vec3f magneticVarianceIn,
		math::vec3f accelerationVarianceIn) :
...
struct FilterBasicControlRegister
{
	...
	math::vec3f gyroLimit; ///< The gyroLimit field.
...
{
	math::vec3f minFiltering; ///< The minFiltering field.
	math::vec3f maxFiltering; ///< The maxFiltering field.
	...
	VpeMagnetometerAdvancedTuningRegister(
		math::vec3f minFilteringIn,
		math::vec3f maxFilteringIn,
...
struct VpeGryoBasicTuningRegister
{
	math::vec3f angularWalkVariance; ///< The angularWalkVariance field.
	math::vec3f baseTuning; ///< The baseTuning field.
	math::vec3f adaptiveTuning; ///< The adaptiveTuning field.

	VpeGryoBasicTuningRegister() { }

	/// \brief Creates an initializes a new VpeGryoBasicTuningRegister structure.
	///
	/// \param[in] angularWalkVarianceIn Value to initialize the angularWalkVariance field with.
	/// \param[in] baseTuningIn Value to initialize the baseTuning field with.
	/// \param[in] adaptiveTuningIn Value to initialize the adaptiveTuning field with.
	VpeGryoBasicTuningRegister(
		math::vec3f angularWalkVarianceIn,
		math::vec3f baseTuningIn,
		math::vec3f adaptiveTuningIn) :
		angularWalkVariance(angularWalkVarianceIn),
		baseTuning(baseTuningIn),
